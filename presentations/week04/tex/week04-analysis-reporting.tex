...
\begin{frame}{What Is an Analytical Framework?}
    ...
    \begin{enumerate}
        ...
        \item Your \textbf{literature review} and theoretical lens (Week 3)
    \end{enumerate}
    \vspace{0.3cm}
...
\begin{frame}{Thinking About Your Own Framework}
    ...
    \vspace{0.3cm}
    \begin{enumerate}
        \item \textbf{What is your theoretical lens?} What theory or concept from your literature will guide your analysis?
        \vspace{0.2cm}
